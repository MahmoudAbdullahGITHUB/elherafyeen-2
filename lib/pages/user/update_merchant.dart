...
class UpdateMerchant extends StatefulWidget {
  UpdateMerchant({Key key}) : super(key: key);

  @override
  _UpdateMerchantState createState() => _UpdateMerchantState();
}

class _UpdateMerchantState extends State<UpdateMerchant> {
  var image;
        ...
        ElevatedButton(
            ...
            onPressed: () async {
              if (user.typeId == "9" && user.pos_sub_id == "1") {
                ...
                Fluttertoast.showToast(msg: "pay_for_store".tr());
            }),
          ...
          ElevatedButton(
              ...
              onPressed: () async {
                Navigator.push(
                    context,
                    CupertinoPageRoute(
                        builder: (_) => MyProductsPage(userID: user.userId)));
              }),
        SizedBox(height: 10),
        Text("yourQr".tr()),
        SizedBox(height: 6),
