...
class UpdateCaptines extends StatefulWidget {
  UpdateCaptines({Key key}) : super(key: key);

  @override
  _UpdateCaptinesState createState() => _UpdateCaptinesState();
}

class _UpdateCaptinesState extends State<UpdateCaptines> {
  var image;
  ...
  var carTypeCtrl = new TextEditingController();
