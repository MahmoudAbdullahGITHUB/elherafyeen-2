...
class ServicesPagePage extends StatefulWidget {
  double lat;
  double lng;
  String id;

  ServicesPagePage({Key key, this.lng, this.lat, this.id}) : super(key: key);

  @override
  _ServicesPagePageState createState() => _ServicesPagePageState();
}

class _ServicesPagePageState extends State<ServicesPagePage> {
  @override
