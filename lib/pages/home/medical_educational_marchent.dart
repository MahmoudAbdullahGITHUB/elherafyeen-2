...
class MedicalEducationalMerchant extends StatefulWidget {
  double lat;
  double lng;

  MedicalEducationalMerchant({Key key, this.lng, this.lat}) : super(key: key);

  @override
  _MedicalEducationalMerchantState createState() =>
      _MedicalEducationalMerchantState();
}

class _MedicalEducationalMerchantState
    extends State<MedicalEducationalMerchant> {
  @override
