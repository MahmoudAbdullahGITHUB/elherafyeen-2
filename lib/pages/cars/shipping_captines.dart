...
class ShippingCaptines extends StatefulWidget {
  String storeId;
  String name;
  double latitude, longitude;

  ShippingCaptines(
      {Key key, this.storeId, this.name, this.latitude, this.longitude})
      : super();

  @override
  _ShippingCaptinesState createState() => _ShippingCaptinesState();
}

class _ShippingCaptinesState extends State<ShippingCaptines> {
