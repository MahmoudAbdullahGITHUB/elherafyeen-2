...
class StoreVendors extends StatefulWidget {
  String storeId;
  String name;

  StoreVendors({Key key, this.storeId, this.name}) : super();

  @override
  _StoreVendorsState createState() => _StoreVendorsState();
}

class _StoreVendorsState extends State<StoreVendors> {
  double latitude;
  double longitude;
  var currentLocation;
  ...
  getVendors() async {
    vendros = await HomeApi.getToolsStoreById(
